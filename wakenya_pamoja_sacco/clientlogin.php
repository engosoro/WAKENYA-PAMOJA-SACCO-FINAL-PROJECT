    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          ...
          <form method="post" action="clientdashboard.php">
          ...
          <p class="mb-0">
            <a href="clientsignup.php" class="text-center">Register a new account</a>
          </p><!-- Log on to alphacodecamp.com.ng for more projects! -->
